...
typeahead.typeahead({
    ...
    templates: {
        ...
        suggestion: Handlebars.compile('<div class="row"><div class="col-xs-8"><strong>{{value}}</strong></div>  <div class="col-xs-1"><img class="typeahead_photo" src="https://graph.facebook.com/v2.3/{{fbid}}/picture"/></div></div>')
    }
}, {
    ...
    templates: {
        ...
        suggestion: Handlebars.compile('<div class="row"><div class="col-xs-8"><strong>{{value}}</strong></div>  <div class="col-xs-1"><img class="typeahead_photo" src="{{photoUrl}}" height="50" width="50"/></div></div>')
    }
});
